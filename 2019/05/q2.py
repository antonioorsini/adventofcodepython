    ...
    def runProgram( self ):
        ...
        while idxs <= len( self.p ):
            ...
            if opcode == 99:
                ...
                print(self.readMode(command[1], modes[2])) # this should be zeros
            elif opcode == 5:
